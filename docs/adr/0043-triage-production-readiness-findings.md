...
The accepted trade-offs are written down, so a later reviewer, or the author after six months, sees which corners are deliberate. The cost is that this record has to be revisited when a trade-off stops being acceptable, which is the point of recording it.

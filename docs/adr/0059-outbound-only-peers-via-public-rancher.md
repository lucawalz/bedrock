...
The public control-plane load balancer still needs a firewall perimeter. It stays reachable for the home cluster's CAPI lifecycle today, but leaving it open to the internet is a gap, and closing it to home egress is tracked separately.

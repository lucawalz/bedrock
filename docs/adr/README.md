...
- [0027. Guarantee a usable CAPI node snapshot at all times](0027-durable-capi-node-snapshot-pipeline.md) (accepted, CAPI estate superseded by 0062 and 0063)
...
- [0083. Rename the control-plane node from master to cp-1](0083-rename-control-plane-node-to-cp-1.md) (proposed)
